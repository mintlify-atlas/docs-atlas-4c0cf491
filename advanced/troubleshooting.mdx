...
Common issues and solutions for Neru. If you encounter problems, start with the Quick Diagnosis section below.
...
<Accordion title="Homebrew fails">
```bash
...
<Accordion title="No hints/grids appear">
**Check:**
...
<Accordion title="Misaligned hints/grids">
...
<Accordion title="No hints in menubar/Dock">
...
<Accordion title="VS Code: Hints don't appear in editor">
...
<Accordion title="Adobe apps: Hints misaligned or missing">
...
<Accordion title="Mission Control: No hints">
...
<Warning>
`detect_mission_control` only works on macOS 26.x (Tahoe). Do not enable this if your macOS version is below Tahoe (26.x)!
</Warning>
</Accordion>
...
4. **Consider a PR:**
    ...
    - See the [Development Guide](https://github.com/y3owk1n/neru/blob/main/docs/DEVELOPMENT.md) for contribution guidelines
